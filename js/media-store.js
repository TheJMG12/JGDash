...
(function (global) {
  ...
  function defaultData() {
    return {
      ...
      watchlist: [
        { id: uid(), title: 'Moneyball', type: 'movie', genre: 'Drama', year: 2011, runtime: '133m', service: 'Netflix', status: 'Want to Watch', priority: 'medium', rating: 0, note: 'Process over narrative', tags: 'sports, strategy', poster: '', why: 'Ops mindset', addedAt: daysAgo(10), progress: '' },
        { id: uid(), title: 'The Last Dance', type: 'show', genre: 'Documentary', year: 2020, runtime: '10 ep', service: 'Netflix', status: 'Watching', priority: 'high', rating: 0, note: 'Ep 4', tags: 'sports', poster: '', why: 'Leadership under pressure', addedAt: daysAgo(20), progress: 'S1E4' },
        { id: uid(), title: 'Arrival', type: 'movie', genre: 'Sci-Fi', year: 2016, runtime: '116m', service: 'Prime', status: 'Watched', priority: 'low', rating: 5, note: 'Language shapes thought', tags: 'sci-fi', poster: '', why: '', addedAt: daysAgo(60), progress: '' },
        { id: uid(), title: 'Slow Horses', type: 'show', genre: 'Thriller', year: 2022, runtime: 'S3', service: 'Apple TV+', status: 'Paused', priority: 'medium', rating: 0, note: 'Resume later', tags: 'spy', poster: '', why: 'Twisty spy craft', addedAt: daysAgo(30), progress: 'S2E3' },
        { id: uid(), title: 'Dune: Part Two', type: 'movie', genre: 'Sci-Fi', year: 2024, runtime: '166m', service: 'Max', status: 'Want to Watch', priority: 'high', rating: 0, note: '', tags: 'epic', poster: '', why: 'Visual spectacle', addedAt: daysAgo(5), progress: '' },
        { id: uid(), title: 'Chernobyl', type: 'show', genre: 'Drama', year: 2019, runtime: '5 ep', service: 'Max', status: 'Watched', priority: 'low', rating: 5, note: 'Systems failure study', tags: 'history', poster: '', why: '', addedAt: daysAgo(90), progress: '' }
      ],
      books: [
        { id: uid(), title: 'The Psychology of Money', author: 'Morgan Housel', genre: 'Finance', pages: 256, format: 'ebook', status: 'Finished', priority: 'medium', rating: 5, notes: 'Behavior > formulas', tags: 'finance', progressPct: 100, why: 'Investing mindset', addedAt: daysAgo(100), startDate: daysAgo(80), finishDate: daysAgo(40), quotes: ['Room for error matters.'] },
        { id: uid(), title: 'Atomic Habits', author: 'James Clear', genre: 'Productivity', pages: 320, format: 'physical', status: 'Reading', priority: 'high', rating: 0, notes: 'Identity-based habits', tags: 'productivity', progressPct: 42, why: 'Habit tracker alignment', addedAt: daysAgo(25), startDate: daysAgo(20), finishDate: '', quotes: [] },
        { id: uid(), title: 'The Guns of August', author: 'Barbara Tuchman', genre: 'History', pages: 511, format: 'physical', status: 'Want to Read', priority: 'medium', rating: 0, notes: '', tags: 'history', progressPct: 0, why: 'WWI decision cascades', addedAt: daysAgo(14), startDate: '', finishDate: '', quotes: [] },
        { id: uid(), title: 'Project Hail Mary', author: 'Andy Weir', genre: 'Fiction', pages: 476, format: 'audiobook', status: 'Want to Read', priority: 'high', rating: 0, notes: '', tags: 'fiction', progressPct: 0, why: 'Fun recovery read', addedAt: daysAgo(7), startDate: '', finishDate: '', quotes: [] },
        { id: uid(), title: 'Security Engineering', author: 'Ross Anderson', genre: 'Cybersecurity', pages: 1232, format: 'ebook', status: 'Reference', priority: 'low', rating: 5, notes: 'Keep as desk reference', tags: 'cybersecurity', progressPct: 15, why: 'Deep systems security', addedAt: daysAgo(200), startDate: daysAgo(180), finishDate: '', quotes: [] },
        { id: uid(), title: 'Deep Work', author: 'Cal Newport', genre: 'Productivity', pages: 296, format: 'ebook', status: 'Paused', priority: 'medium', rating: 0, notes: 'Resume after travel week', tags: 'productivity', progressPct: 55, why: 'Focus blocks', addedAt: daysAgo(50), startDate: daysAgo(45), finishDate: '', quotes: [] }
      ],
